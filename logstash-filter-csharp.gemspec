Gem::Specification.new do |s|
  ...
  s.description = 'This gem is a logstash plugin required to be installed on top of the Logstash core pipeline using $LS_HOME/bin/logstash-plugin install logstash-filter-csarp. This gem is not a stand-alone program.'
  s.authors = ['Julian Rüth']
